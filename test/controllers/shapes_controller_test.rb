...
class ShapesControllerTest < ActionController::TestCase
  ...
  test "should create shape" do
    assert_difference('Shape.count') do
      post :create, shape: { name: @shape.name, public: @shape.public, shape: @shape.shape, user_id: @shape.user_id }
    end
  ...
  test "should update shape" do
    patch :update, id: @shape, shape: { name: @shape.name, public: @shape.public, shape: @shape.shape, user_id: @shape.user_id }
    assert_redirected_to shape_path(assigns(:shape))
  end
